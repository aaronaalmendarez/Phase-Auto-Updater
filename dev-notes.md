...
- Windows builds produce a setup executable plus the raw per-user MSI. The setup app embeds the MSI, shows the standard wizard, enables startup, and opens the updater after install.
